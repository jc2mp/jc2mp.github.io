...
<span class="top-nav-left">&nbsp;</span>
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FWindows+Server%2FSteamCMD">
Log in</a>
<span class="top-nav-right">&nbsp;</span></li>
</ul>
</div>
...
<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FWindows+Server%2FSteamCMD" title="This is a special page, you cannot edit the page itself">Special page</a></li> </ul></div>
...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Server/Getting+started/Windows+Server/SteamCMD">
<h2>Log in</h2>
...
<input type="hidden" name="wpLoginToken" value="174333eee39acff5ada9fa287a2af752"/></form>
</div>
<div id="loginend"></div>
