...
<head>
<title>Lua/Tutorials/Beginner/Beginner - JC2-MP Documentation</title>
<meta charset="UTF-8"/>
<meta name="generator" content="MediaWiki 1.21.3"/>
<meta name="robots" content="noindex,nofollow"/>
<script type="text/javascript">
//<![CDATA[
try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:1387493058,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/acv=4125811108/"},atok:"18e551c24bf0de1f962f19ce340d4682",petok:"1f9d3e5afae68c467d7119eef24d104bfb978450-1387586358-1800",zone:"jc-mp.com",rocket:"0",apps:{"abetterbrowser":{"ie":"8"}}}];var a=document.createElement("script"),b=document.getElementsByTagName("script")[0];a.async=!0;a.src="//ajax.cloudflare.com/cdn-cgi/nexp/acv=616370821/cloudflare.min.js";b.parentNode.insertBefore(a,b);}}catch(e){};
//]]>
</script>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Lua/Tutorials/Beginner/Beginner","wgTitle":"Lua/Tutorials/Beginner/Beginner","wgCurRevisionId":24558,"wgArticleId":2833,"wgIsArticle":true,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Lua/Tutorials/Beginner/Beginner","wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FTutorials%2FBeginner%2FBeginner&amp;returntoquery=oldid%3D24558">
Log in</a>
...
<li id="t-print"><a href="/index.php?title=Lua/Tutorials/Beginner/Beginner&amp;oldid=24558&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
<li id="t-permalink"><a href="/index.php?title=Lua/Tutorials/Beginner/Beginner&amp;oldid=24558" title="Permanent link to this revision of the page">Permanent link</a></li>
...
<div id="contentSub"><span class="subpages">&lt; <a href="/Lua" title="Lua">Lua</a>&lrm; | <a href="/Lua/Tutorials" title="Lua/Tutorials">Tutorials</a></span><div id="mw-revision-info">Revision as of 20:25, 16 December 2013 by <a href="/User:Dreadmullet" title="User:Dreadmullet" class="mw-userlink">Dreadmullet</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Dreadmullet&amp;action=edit&amp;redlink=1" class="new" title="User talk:Dreadmullet (page does not exist)">Talk</a> | <a href="/Special:Contributions/Dreadmullet" title="Special:Contributions/Dreadmullet">contribs</a>)</span></div><br/>
<div id="mw-revision-nav">(<a href="/index.php?title=Lua/Tutorials/Beginner/Beginner&amp;diff=prev&amp;oldid=24558" title="Lua/Tutorials/Beginner/Beginner">diff</a>) <a href="/index.php?title=Lua/Tutorials/Beginner/Beginner&amp;direction=prev&amp;oldid=24558" title="Lua/Tutorials/Beginner/Beginner">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div></div>
...
<ul><li> <a rel="nofollow" class="external text" href="http://lua-users.org/wiki/LuaTypesTutorial">Types</a>
</li><li> <a rel="nofollow" class="external text" href="http://lua-users.org/wiki/ControlStructureTutorial">Control structures</a>
<ul><li> This tutorial only uses the 'if' statement.
</li></ul>
</li><li> <a rel="nofollow" class="external text" href="http://lua-users.org/wiki/TablesTutorial">Tables</a>
<ul><li> Tables can get complex, but this tutorial uses a simple case.
</li></ul>
</li><li> <a rel="nofollow" class="external text" href="http://lua-users.org/wiki/FunctionsTutorial">Functions</a>
</li><li> <a rel="nofollow" class="external text" href="http://lua-users.org/wiki/ScopeTutorial">Scope</a>
</li></ul>
...
<ul><li> server - Server-side scripts.
</li><li> client - Client-side scripts.
</li><li> shared - Loaded by both client and server.
</li></ul>
...
<ul><li> <i>script</i> - A single lua file, such as "Skydive.lua". People may also use it to refer to an entire module, confusingly.
</li><li> <i>module</i> - All lua files located in one directory that the server loads at once, such as <i>scripts/Skydive/</i>. In our case, the module is called Skydive.
</li></ul>
...
<ul><li> Classes: These are classes that there can be instances of; functions are called like, <i>somePlayerInstance:GetName()</i>
<ul><li> <a href="/Lua/Server/Player" title="Lua/Server/Player">Player</a>, <a href="/Lua/Server/Vehicle" title="Lua/Server/Vehicle">Vehicle</a>, <a href="/Lua/Server/World" title="Lua/Server/World">World</a>, <a href="/Lua/Shared/Vector3" title="Lua/Shared/Vector3">Vector3</a>, <a href="/Lua/Shared/Timer" title="Lua/Shared/Timer">Timer</a>
</li></ul>
</li><li> Global classes: These have functions you can call like, <i>Class:Function()</i>
<ul><li> <a href="/Lua/Server/Server" title="Lua/Server/Server">Server</a>, <a href="/Lua/Server/Chat" title="Lua/Server/Chat">Chat</a>
</li></ul>
</li><li> Enums: These are, in a way, lists of values. Used like, <i>WeaponSlot.Primary</i>
<ul><li> <a href="/Lua/Server/CollisionGroup" title="Lua/Server/CollisionGroup">CollisionGroup</a>, <a href="/Lua/Shared/AnimationState" title="Lua/Shared/AnimationState">AnimationState</a>, <a href="/Lua/Shared/WeaponSlot" title="Lua/Shared/WeaponSlot">WeaponSlot</a>
</li></ul>
</li></ul>
<p><br/>
</p>
...
Hello <span class="sy0">=</span> <span class="kw1">function</span><span class="br0">&#40;</span><span class="br0">&#41;</span>
...
OnPlayerChat <span class="sy0">=</span> <span class="kw1">function</span><span class="br0">&#40;</span>args<span class="br0">&#41;</span>
...
<div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><div class="lua source-lua"><pre class="de1">OnPlayerChat <span class="sy0">=</span> <span class="kw1">function</span><span class="br0">&#40;</span>args<span class="br0">&#41;</span>
...
Retrieved from "<a href="http://wiki.jc-mp.com/index.php?title=Lua/Tutorials/Beginner/Beginner&amp;oldid=24558">http://wiki.jc-mp.com/index.php?title=Lua/Tutorials/Beginner/Beginner&amp;oldid=24558</a>"</div>
...
<td align="center">
<ul id="f-list">
<li id="f-lastmod"> This page was last modified on 16 December 2013, at 20:25.</li>
<li id="f-viewcount">This page has been accessed 3,661 times.</li>
