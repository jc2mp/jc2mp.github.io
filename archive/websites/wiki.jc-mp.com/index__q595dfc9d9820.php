...
<link rel="alternate" type="application/atom+xml" title="&quot;Lua/Tutorials/Class basics&quot; Atom feed" href="/index.php?title=Lua/Tutorials/Class_basics&amp;feed=atom&amp;action=history" />
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lua_Tutorials_Class_basics skin-cavendish action-history"><script type="text/javascript">
//<![CDATA[
...
<div id="globalWrapper" class="history">
	<div id="p-personal" class="portlet">
		...
		<div class="pBody">
			...
			<li id="pt-login" class="top-nav-element">
				...
				<a class="top-nav-mid " 
				   href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FTutorials%2FClass+basics&amp;returntoquery=action%3Dhistory">
	...
	<div id="header">
		...
		<a
		href="/Main_Page"
		title="Main Page">Revision history of &quot;Lua/Tutorials/Class basics&quot; - JC2-MP Documentation</a></h6>
		<div id="p-cactions" class="portlet"><ul>
				...
				<li id="ca-history" class="selected"><a href="/index.php?title=Lua/Tutorials/Class_basics&amp;action=history" title="Past revisions of this page">History</a></li>			</ul></div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="feedlinks"><a href="/index.php?title=Lua/Tutorials/Class_basics&amp;feed=atom&amp;action=history" id="feed-atom" rel="alternate" type="application/atom+xml" class="feedlink" title="Atom feed for this page">Atom</a></li>
		...
		<div id="column-content">
			<div id="content">
				<a id="top"></a>
								<h1 id="firstHeading" class="firstHeading">Revision history of "Lua/Tutorials/Class basics"</h1>
				<div id="bodyContent">
					<h3 id="siteSub">From JC2-MP Documentation</h3>
					<div id="contentSub"><a href="/index.php?title=Special:Log&amp;page=Lua%2FTutorials%2FClass+basics" title="Special:Log">View logs for this page</a></div>
															<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>					<!-- start content -->
					<div id="mw-content-text"><form action="/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Lua/Tutorials/Class_basics" name="title" />
...
<li><span class="mw-history-histlinks">(cur | <a href="/index.php?title=Lua/Tutorials/Class_basics&amp;diff=26082&amp;oldid=26080" title="Lua/Tutorials/Class basics">prev</a>)</span><input type="radio" value="26082" style="visibility:hidden" name="oldid" id="mw-oldid-null" /><input type="radio" value="26082" checked="checked" name="diff" id="mw-diff-26082" /> <a href="/index.php?title=Lua/Tutorials/Class_basics&amp;oldid=26082" title="Lua/Tutorials/Class basics" class="mw-changeslist-date">10:52, 4 March 2014</a>‎ <span class='history-user'><a href="/User:Dreadmullet" title="User:Dreadmullet" class="mw-userlink">Dreadmullet</a>  <span class="mw-usertoollinks">(<a href="/User_talk:Dreadmullet" title="User talk:Dreadmullet">Talk</a> | <a href="/Special:Contributions/Dreadmullet" title="Special:Contributions/Dreadmullet">contribs</a>)</span></span>‎ <abbr class='minoredit' title='This is a minor edit'>m</abbr> <span class="mw-changeslist-separator">. .</span> <span class="history-size">(6,073 bytes)</span> <span dir="ltr" class="mw-plusminus-null" title="6,073 bytes after change">(0)</span>‎ <span class="mw-changeslist-separator">. .</span>  <span class="comment">(Typo)</span></li>
<li><span class="mw-history-histlinks">(<a href="/index.php?title=Lua/Tutorials/Class_basics&amp;diff=26082&amp;oldid=26080" title="Lua/Tutorials/Class basics">cur</a> | prev)</span><input type="radio" value="26080" checked="checked" name="oldid" id="mw-oldid-26080" /><input type="radio" value="26080" name="diff" id="mw-diff-26080" /> <a href="/index.php?title=Lua/Tutorials/Class_basics&amp;oldid=26080" title="Lua/Tutorials/Class basics" class="mw-changeslist-date">20:53, 3 March 2014</a>‎ <span class='history-user'><a href="/User:Dreadmullet" title="User:Dreadmullet" class="mw-userlink">Dreadmullet</a>  <span class="mw-usertoollinks">(<a href="/User_talk:Dreadmullet" title="User talk:Dreadmullet">Talk</a> | <a href="/Special:Contributions/Dreadmullet" title="Special:Contributions/Dreadmullet">contribs</a>)</span></span>‎ <span class="mw-changeslist-separator">. .</span> <span class="history-size">(6,073 bytes)</span> <strong dir="ltr" class="mw-plusminus-pos" title="6,073 bytes after change">(+6,073)</strong>‎ <span class="mw-changeslist-separator">. .</span>  <span class="comment">(Created page with &quot;Classes are used everywhere in the JC2-MP API. <a href="/Lua/Server/Player" title="Lua/Server/Player">Player</a> is a class, as is <a href="/Lua/Server/Vehicle" title="Lua/Server/Vehicle">Vehicle</a> and <a href="/Lua/Shared/Vector3" title="Lua/Shared/Vector3">Vector3</a>. You can also d...&quot;)</span></li>
</ul>
</form></div><div class="printfooter">
Retrieved from "<a href="http://wiki.jc-mp.com/Lua/Tutorials/Class_basics">http://wiki.jc-mp.com/Lua/Tutorials/Class_basics</a>"</div>
