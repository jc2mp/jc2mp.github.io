...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Player">
	<h2>Log in</h2>
...
<div id="p-personal" class="">
	...
	<ul>
		...
		<li id="pt-anonlogin" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Player" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
	</ul>
</div>
...
<div id="p-namespaces" class="vectorTabs">
	<h5>Namespaces</h5>
	<ul>
					<li  id="ca-nstab-special" class="selected"><span><a href="/index.php?title=Special:UserLogin&amp;returnto=Player"  title="This is a special page, you cannot edit the page itself">Special page</a></span></li>
			</ul>
</div>
