...
<span class="top-nav-left">&nbsp;</span>
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FInstalling+scripts">
Log in</a>
<span class="top-nav-right">&nbsp;</span></li>
</ul>
</div>
...
<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FInstalling+scripts" title="This is a special page, you cannot edit the page itself">Special page</a></li> </ul></div>
...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Server/Installing+scripts">
<h2>Log in</h2>
...
<input type="hidden" name="wpLoginToken" value="ec3e4579dca185b2af0f94af8c452a43"/></form>
</div>
<div id="loginend"></div>
