...
<head>
<title>View source for Errors - JC2-MP Documentation</title>
<meta charset="UTF-8" />
<meta name="generator" content="MediaWiki 1.19.1" />
<link rel="next" href="http://wiki.jc-mp.com/index.php/Errors" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Errors","wgTitle":"Errors","wgCurRevisionId":330,"wgArticleId":4,"wgIsArticle":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"Errors","wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Errors skin-vector action-edit">
		...
		<div id="content" class="mw-body">
			...
			<h1 id="firstHeading" class="firstHeading">
				<span dir="auto">View source for Errors</span>
			</h1>
			<!-- /firstHeading -->
			<!-- bodyContent -->
			<div id="bodyContent">
								<!-- subtitle -->
				<div id="contentSub">← <a href="/index.php/Errors" title="Errors">Errors</a></div>
				<!-- /subtitle -->
																<!-- jumpto -->
...
Download and run the [http://www.microsoft.com/en-us/download/details.aspx?id=35 | DirectX End-User Runtime Web Installer].

=====  Missing d3dx10_43.dll! ===== 
Download and run the [http://www.microsoft.com/en-us/download/details.aspx?id=35 | DirectX End-User Runtime Web Installer].

=====  Missing MSVCP100.dll! ===== 
Download and run the [http://www.microsoft.com/en-us/download/details.aspx?id=8328 | Microsoft Visual C++ 2010 SP1 Redistributable Package (x86)].

=====  Missing MSVCP110.dll! ===== 
Download and run the [http://www.microsoft.com/en-us/download/details.aspx?id=30679 | Microsoft Visual C++ 2012 Redistributable Package (x86)].
...
Download and run: [http://www.microsoft.com/en-us/download/details.aspx?id=35 | DirectX End-User Runtime Web Installer]

===== Game crashes on launch =====
Make sure your game is running version 1.0.0.2. (All Steam copies automatically update to this version.)
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="/index.php/Errors" title="Errors">Errors</a>.</p>
</div>				<!-- /bodycontent -->
								<!-- printfooter -->
...
<div id="p-personal" class="">
	...
	<ul>
		<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Errors&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
	</ul>
</div>
...
<div id="p-views" class="vectorTabs">
	...
	<ul>
					...
					<li id="ca-viewsource" class="selected"><span><a href="/index.php?title=Errors&amp;action=edit"  title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li>
