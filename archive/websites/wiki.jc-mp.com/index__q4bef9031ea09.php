...
<head>
<meta charset="UTF-8"/>
<title>View source for Lua/Tutorials/Client-side scripts - JC2-MP Documentation</title>
<meta http-equiv="X-UA-Compatible" content="IE=EDGE"/>
<meta name="generator" content="MediaWiki 1.23.7"/>
<meta name="robots" content="noindex,nofollow"/>
<script type="text/javascript">
//<![CDATA[
try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:0,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/dok3v=1613a3a185/"},atok:"3d4685a8242fc8ea9ad5ff8147ae6aeb",petok:"c7e83684c5fe3bb691b3cb1d5a9c86dc8e8e0a50-1426650966-1800",zone:"jc-mp.com",rocket:"0",apps:{"abetterbrowser":{"ie":"8"}}}];!function(a,b){a=document.createElement("script"),b=document.getElementsByTagName("script")[0],a.async=!0,a.src="//ajax.cloudflare.com/cdn-cgi/nexp/dok3v=919620257c/cloudflare.min.js",b.parentNode.insertBefore(a,b)}()}}catch(e){};
//]]>
</script>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lua_Tutorials_Client-side_scripts skin-cavendish action-edit"><script type="text/javascript">
//<![CDATA[
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FTutorials%2FClient-side+scripts&amp;returntoquery=action%3Dedit">
...
<h6>
<a href="/Main_Page" title="Main Page">View source for Lua/Tutorials/Client-side scripts - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource" class="selected"><a href="/index.php?title=Lua/Tutorials/Client-side_scripts&amp;action=edit" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">View source for Lua/Tutorials/Client-side scripts</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub">← <a href="/Lua/Tutorials/Client-side_scripts" title="Lua/Tutorials/Client-side scripts">Lua/Tutorials/Client-side scripts</a></div>
...
</p><textarea readonly="" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">Client-side scripts work very similarly to server scripts. The server automatically sends clients scripts when they join, and also when a module is reloaded. But other than that, the only difference is the classes and functions available. Clients cannot spawn vehicles or set their own health, for example; server scripts must do that.
...
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="/Lua/Tutorials/Client-side_scripts" title="Lua/Tutorials/Client-side scripts">Lua/Tutorials/Client-side scripts</a>.</p>
