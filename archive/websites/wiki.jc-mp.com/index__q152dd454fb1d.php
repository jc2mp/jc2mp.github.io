...
<head>
<meta charset="UTF-8" />
<title>View source for Lua/Shared - JC2-MP Documentation</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lua_Shared skin-cavendish action-edit">
<div id="internal"></div>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FShared&amp;returntoquery=action%3Dedit">
...
<h6>
<a href="/Main_Page" title="Main Page">View source for Lua/Shared - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource" class="selected"><a href="/index.php?title=Lua/Shared&amp;action=edit" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">View source for Lua/Shared</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub">← <a href="/Lua/Shared" title="Lua/Shared">Lua/Shared</a></div>
...
'''[[Lua/Shared/BaseEventManager|BaseEventManager]]'''

:[[Lua/Shared/Console|Console]]

:[[Lua/Shared/Events|Events]]

:[[Lua/Shared/Network|Network]]
...
'''[[Lua/Shared/Event|Event]]'''

'''[[Lua/Shared/MD5|MD5]]'''

'''[[Lua/Shared/SHA1|SHA1]]'''

'''[[Lua/Shared/SHA256|SHA256]]'''

'''[[Lua/Shared/SharedObject|SharedObject]]'''

'''[[Lua/Shared/SteamId|SteamId]]'''

'''[[Lua/Shared/Timer|Timer]]'''

'''[[Lua/Shared/Transform2|Transform2]]'''

'''[[Lua/Shared/Transform3|Transform3]]'''

'''[[Lua/Shared/Vector3|Vector3]]'''

'''[[Lua/Shared/Vector2|Vector2]]'''

'''[[Lua/Shared/Weapon|Weapon]]'''
...
'''[[Lua/Shared/AnimationState|AnimationState]]'''

'''[[Lua/Shared/AssetLocation|AssetLocation]]'''

'''[[Lua/Shared/CharacterId|CharacterId]]'''

'''[[Lua/Shared/DamageEntity|DamageEntity]]'''

'''[[Lua/Shared/PlayerState|PlayerState]]'''

'''[[Lua/Shared/VehicleClass|VehicleClass]]'''

'''[[Lua/Shared/VehicleId|VehicleId]]'''

'''[[Lua/Shared/VehicleSeat|VehicleSeat]]'''

'''[[Lua/Shared/WeaponSlot|WeaponSlot]]'''
...
'''[[Lua/Shared/Functions/IsNaN|IsNaN(object)]]'''

'''[[Lua/Shared/Functions/IsValid|IsValid(object)]]'''

'''[[Lua/Shared/Functions/IsValid|IsValid(object, boolean)]]'''

'''[[Lua/Shared/Functions/Copy|Copy(object)]]'''

'''[[Lua/Shared/Functions/FNV|FNV(string)]]'''

'''[[Lua/Shared/Functions/FNV|FNV(string, number)]]'''

'''[[Lua/Shared/Functions/SetUnicode|SetUnicode(boolean)]]'''
...
'''[[Lua/Shared/string/split|string.split(string, string [, boolean])]]'''

'''[[Lua/Shared/string/trim|string.trim(string)]]'''

'''[[Lua/Shared/table/count|table.count(table)]]'''

'''[[Lua/Shared/table/find|table.find(table, object)]]'''

'''[[Lua/Shared/table/randomvalue|table.randomvalue(table)]]'''

'''[[Lua/Shared/math/clamp|math.clamp(number, number, number)]]'''

'''[[Lua/Shared/math/lerp|math.lerp(object, object, number)]]'''

&lt;/font>
</textarea><div class="templatesUsed"><div class="mw-templatesUsedExplanation"><p>Template used on this page:
</p></div><ul>
<li><a href="/Template:Lua/Events/Shared" title="Template:Lua/Events/Shared">Template:Lua/Events/Shared</a> (<a href="/index.php?title=Template:Lua/Events/Shared&amp;action=edit" title="Template:Lua/Events/Shared">view source</a>) </li></ul></div><p id="mw-returnto">Return to <a href="/Lua/Shared" title="Lua/Shared">Lua/Shared</a>.</p>
</div><div class="printfooter">
Retrieved from "<a href="https://wiki.jc-mp.com/Lua/Shared">https://wiki.jc-mp.com/Lua/Shared</a>"</div>
