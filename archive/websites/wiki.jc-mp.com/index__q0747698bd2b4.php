...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Server/Getting_started/Windows_Server","wgTitle":"Server/Getting started/Windows Server","wgCurRevisionId":22679,"wgArticleId":2835,"wgIsArticle":true,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Getting_started/Windows_Server","wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FWindows+Server&amp;returntoquery=oldid%3D16207">
Log in</a>
...
<li id="t-print"><a href="/index.php?title=Server/Getting_started/Windows_Server&amp;oldid=16207&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
...
<div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr">The revision #16207 of the page named "Server/Getting started/Windows Server" does not exist.
</p><p>This is usually caused by following an outdated history link to a page that has been deleted.
Details can be found in the <a rel="nofollow" class="external text" href="http://wiki.jc-mp.com/index.php?title=Special:Log/delete&amp;page=Server/Getting_started/Windows_Server">deletion log</a>.</div><div class="printfooter">
...
<li id="f-viewcount">This page has been accessed 53 times.</li>
