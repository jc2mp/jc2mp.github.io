...
<head>
<meta charset="UTF-8" />
<title>Difference between revisions of "Server/Getting started/Windows Server/SteamCMD" - JC2-MP Documentation</title>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FWindows+Server%2FSteamCMD&amp;returntoquery=diff%3Dprev%26oldid%3D26735">
...
<h6>
<a href="/Main_Page" title="Main Page">Difference between revisions of &quot;Server/Getting started/Windows Server/SteamCMD&quot; - JC2-MP Documentation</a></h6>
...
<li id="t-print"><a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;diff=prev&amp;oldid=26735&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">Difference between revisions of "Server/Getting started/Windows Server/SteamCMD"</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub"><span class="subpages">&lt; <a href="/Server" title="Server">Server</a>&lrm; | <a href="/Server/Getting_started/Windows_Server" title="Server/Getting started/Windows Server">Getting started/Windows Server</a></span></div>
...
<td colspan='2' class='diff-otitle'><div id="mw-diff-otitle1"><strong><a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;oldid=26461" title="Server/Getting started/Windows Server/SteamCMD">Revision as of 12:40, 6 April 2014</a> (<a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;action=edit&amp;oldid=26461" title="Server/Getting started/Windows Server/SteamCMD">view source</a>)</strong></div><div id="mw-diff-otitle2"><a href="/index.php?title=User:Pricetx&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:Pricetx (page does not exist)">Pricetx</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Pricetx&amp;action=edit&amp;redlink=1" class="new" title="User talk:Pricetx (page does not exist)">Talk</a> | <a href="/Special:Contributions/Pricetx" title="Special:Contributions/Pricetx">contribs</a>)</span></div><div id="mw-diff-otitle3"> <span class="comment">(Re-wrote this page to more closely follow the Linux and FreeBSD pages)</span></div><div id="mw-diff-otitle5"></div><div id="mw-diff-otitle4"><a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;diff=prev&amp;oldid=26461" title="Server/Getting started/Windows Server/SteamCMD" id="differences-prevlink">← Older edit</a></div></td>
<td colspan='2' class='diff-ntitle'><div id="mw-diff-ntitle1"><strong><a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;oldid=26735" title="Server/Getting started/Windows Server/SteamCMD">Latest revision as of 23:34, 20 October 2014</a> (<a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;action=edit" title="Server/Getting started/Windows Server/SteamCMD">view source</a>) </strong></div><div id="mw-diff-ntitle2"><a href="/User:Jman100" title="User:Jman100" class="mw-userlink">Jman100</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Jman100&amp;action=edit&amp;redlink=1" class="new" title="User talk:Jman100 (page does not exist)">Talk</a> | <a href="/Special:Contributions/Jman100" title="Special:Contributions/Jman100">contribs</a>)</span> </div><div id="mw-diff-ntitle3"></div><div id="mw-diff-ntitle5"></div><div id="mw-diff-ntitle4">&#160;</div></td>
</tr><tr><td colspan="2" class="diff-lineno">Line 44:</td>
<td colspan="2" class="diff-lineno">Line 44:</td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'><div>There are a couple of changes to be made to the JC2-MP server itself before running it for the first time.</div></td><td class='diff-marker'>&#160;</td><td class='diff-context'><div>There are a couple of changes to be made to the JC2-MP server itself before running it for the first time.</div></td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'></td><td class='diff-marker'>&#160;</td><td class='diff-context'></td></tr>
<tr><td class='diff-marker'>−</td><td class='diff-deletedline'><div>- First, <del class="diffchange diffchange-inline">copy </del>&quot;default_config&quot; to &quot;config&quot;, and then open the file with a text editor (such as notepad) to change any settings such as the server's name.</div></td><td class='diff-marker'>+</td><td class='diff-addedline'><div>- First, <ins class="diffchange diffchange-inline">rename </ins>&quot;default_config<ins class="diffchange diffchange-inline">.lua</ins>&quot; to &quot;config<ins class="diffchange diffchange-inline">.lua</ins>&quot;, and then open the file with a text editor (such as notepad) to change any settings such as the server's name.</div></td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'></td><td class='diff-marker'>&#160;</td><td class='diff-context'></td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'><div>The next step is to install the latest versions of any official scripts you want. The scripts that ship with the server are outdated and usually non-functional, the best way to grab the latest versions are as follows:</div></td><td class='diff-marker'>&#160;</td><td class='diff-context'><div>The next step is to install the latest versions of any official scripts you want. The scripts that ship with the server are outdated and usually non-functional, the best way to grab the latest versions are as follows:</div></td></tr>
</table><hr class='diff-hr' />
<h2 class='diff-currentversion-title'>Latest revision as of 23:34, 20 October 2014</h2>
...
<li id="f-viewcount">This page has been accessed 47,651 times.</li>
