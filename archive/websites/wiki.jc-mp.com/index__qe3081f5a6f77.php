...
<body class="mediawiki ltr sitedir-ltr ns--1 ns-special mw-special-Userlogin page-Special_UserLogin skin-cavendish action-view">
<div id="internal"></div>
...
<span class="top-nav-right">&nbsp;</span></li>
<li id="pt-anonlogin" class="active top-nav-element">
<span class="top-nav-left">&nbsp;</span>
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FWindows+Server">
Log in</a>
<span class="top-nav-right">&nbsp;</span></li>
</ul>
</div>
...
<h6>
<a href="/Main_Page" title="Main Page">Log in - JC2-MP Documentation</a></h6>
<div id="p-cactions" class="portlet"><ul>
<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FWindows+Server" title="This is a special page, you cannot edit the page itself">Special page</a></li> </ul></div>
...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Server/Getting+started/Windows+Server">
<h2>Log in</h2>
...
<input type="hidden" name="wpLoginToken" value="5a9a3da5ea974223154259c3f06621e7"/></form>
</div>
<div id="loginend"></div>
</div><div class="printfooter">
Retrieved from "<a href="http://wiki.jc-mp.com/Special:UserLogin">http://wiki.jc-mp.com/Special:UserLogin</a>"</div>
