...
//<![CDATA[
try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:0,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/dok3v=1613a3a185/"},atok:"3d4685a8242fc8ea9ad5ff8147ae6aeb",petok:"9603ecda91171bf98a27be01927fcc77b2aa4a00-1434682932-1800",zone:"jc-mp.com",rocket:"0",apps:{"abetterbrowser":{"ie":"8"}}}];!function(a,b){a=document.createElement("script"),b=document.getElementsByTagName("script")[0],a.async=!0,a.src="//ajax.cloudflare.com/cdn-cgi/nexp/dok3v=7e13c32551/cloudflare.min.js",b.parentNode.insertBefore(a,b)}()}}catch(e){};
//]]>
</script>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Server/Getting_started/Linux_Server","wgTitle":"Server/Getting started/Linux Server","wgCurRevisionId":26769,"wgRevisionId":26769,"wgArticleId":2836,"wgIsArticle":true,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Getting_started/Linux_Server","wgIsProbablyEditable":false,"wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Server_Getting_started_Linux_Server skin-cavendish action-view"><script type="text/javascript">
//<![CDATA[
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FLinux+Server&amp;returntoquery=oldid%3D26769">
...
<li id="t-print"><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=26769&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
<li id="t-permalink"><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=26769" title="Permanent link to this revision of the page">Permanent link</a></li>
...
<div id="contentSub"><span class="subpages">&lt; <a href="/Server" title="Server">Server</a></span><div id="mw-revision-info">Revision as of 12:39, 25 December 2014 by <a href="/index.php?title=User:Gim&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:Gim (page does not exist)">Gim</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Gim&amp;action=edit&amp;redlink=1" class="new" title="User talk:Gim (page does not exist)">Talk</a> | <a href="/Special:Contributions/Gim" title="Special:Contributions/Gim">contribs</a>)</span></div><br/>
<div id="mw-revision-nav">(<a href="/index.php?title=Server/Getting_started/Linux_Server&amp;diff=prev&amp;oldid=26769" title="Server/Getting started/Linux Server">diff</a>) <a href="/index.php?title=Server/Getting_started/Linux_Server&amp;direction=prev&amp;oldid=26769" title="Server/Getting started/Linux Server">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div></div>
...
<li class="toclevel-1 tocsection-8"><a href="#Running_SteamCMD_and_downloading_the_server"><span class="tocnumber">2</span> <span class="toctext">Running SteamCMD and downloading the server</span></a></li>
<li class="toclevel-1 tocsection-9"><a href="#Changing_the_server_options"><span class="tocnumber">3</span> <span class="toctext">Changing the server options</span></a></li>
...
<p>First we need to download <a rel="nofollow" class="external text" href="https://developer.valvesoftware.com/wiki/SteamCMD">SteamCMD</a>. SteamCMD is a command-line version of the Steam client. Their libraries are currently 32-bit only, so to run it on 64-bit system you need to install additional libraries as specified below.
</p>
...
<p>This should work on any other Debian-based distribution like Linux Mint etc. Currently tested on <a rel="nofollow" class="external text" href="http://www.ubuntu.com/download/server">Ubuntu Server</a> <b>14.04 LTS</b>.
</p>
...
<p>Now, use your favorite editor to edit the server's configuration file. For most people, nano will be sufficient
</p>
...
<p>It should now say that the server has successfully started.
...
<p>To update the server to the latest version you will need to repeat the procedure <a href="#Running_SteamCMD_and_downloading_the_server">#Running SteamCMD and downloading the server</a> again.
</p>
...
Retrieved from "<a href="http://wiki.jc-mp.com/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=26769">http://wiki.jc-mp.com/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=26769</a>"</div>
...
<td align="center">
<ul id="f-list">
<li id="f-lastmod"> This page was last modified on 25 December 2014, at 12:39.</li>
<li id="f-viewcount">This page has been accessed 15,148 times.</li>
