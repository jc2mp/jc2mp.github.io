...
<input type="hidden" name="wpLoginToken" value="f5e196e3c753cc9e2383b25b2bf7000f" /></form>
</div>
<div id="loginend"></div>
</div>				<!-- /bodycontent -->
								<!-- printfooter -->
...
<div id="p-personal" class="">
	...
	<ul>
		...
		<li id="pt-anonlogin" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Frequently+asked+questions" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
	</ul>
</div>
...
<div id="p-namespaces" class="vectorTabs">
	<h5>Namespaces</h5>
	<ul>
					<li  id="ca-nstab-special" class="selected"><span><a href="/index.php?title=Special:UserLogin&amp;returnto=Frequently+asked+questions"  title="This is a special page, you cannot edit the page itself">Special page</a></span></li>
			</ul>
</div>
