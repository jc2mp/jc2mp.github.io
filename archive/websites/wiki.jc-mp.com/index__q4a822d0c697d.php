...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lua_Tutorials_Iterators skin-cavendish action-view"><script type="text/javascript">
//<![CDATA[
...
<div id="globalWrapper" class="view">
	<div id="p-personal" class="portlet">
		...
		<div class="pBody">
			...
			<li id="pt-login" class="top-nav-element">
				...
				<a class="top-nav-mid " 
				   href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FTutorials%2FIterators&amp;returntoquery=oldid%3D26666">
	...
	<div id="header">
		...
		<a
		href="/Main_Page"
		title="Main Page">Lua/Tutorials/Iterators - JC2-MP Documentation</a></h6>
		<div id="p-cactions" class="portlet"><ul>
				...
				<li id="ca-history"><a href="/index.php?title=Lua/Tutorials/Iterators&amp;action=history" title="Past revisions of this page">History</a></li>			</ul></div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="t-print"><a href="/index.php?title=Lua/Tutorials/Iterators&amp;oldid=26666&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
				<li id="t-permalink"><a href="/index.php?title=Lua/Tutorials/Iterators&amp;oldid=26666" title="Permanent link to this revision of the page">Permanent link</a></li>
		...
		<div id="column-content">
			<div id="content">
				<a id="top"></a>
								<h1 id="firstHeading" class="firstHeading">Lua/Tutorials/Iterators</h1>
				<div id="bodyContent">
				...
				<div id="mw-revision-nav">(<a href="/index.php?title=Lua/Tutorials/Iterators&amp;diff=prev&amp;oldid=26666" title="Lua/Tutorials/Iterators">diff</a>) <a href="/index.php?title=Lua/Tutorials/Iterators&amp;direction=prev&amp;oldid=26666" title="Lua/Tutorials/Iterators">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div></div>
															<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>					<!-- start content -->
					<div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><p>Some of the functions in the API use iterator functions. These must be used with for statements.
</p><p>As an example, if you want to use <a href="/Lua/Server/Server/Functions/GetPlayers" title="Lua/Server/Server/Functions/GetPlayers">Server:GetPlayers</a>, use the following syntax:
</p>
<div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><div class="lua source-lua"><pre class="de1"><span class="kw1">for</span> player <span class="kw2">in</span> Server<span class="sy0">:</span>GetPlayers<span class="br0">&#40;</span><span class="br0">&#41;</span> <span class="kw1">do</span>
	<span class="kw3">print</span><span class="br0">&#40;</span>player<span class="br0">&#41;</span>
<span class="kw1">end</span></pre></div></div>
<h2><span class="mw-headline" id="See_also">See also</span></h2>
<ul>
<li> <a href="/Lua/Server/Server/Functions/GetPlayers" title="Lua/Server/Server/Functions/GetPlayers">Server:GetPlayers</a>
</li>
<li> <a href="/Lua/Server/Server/Functions/GetVehicles" title="Lua/Server/Server/Functions/GetVehicles">Server:GetVehicles</a>
</li>
<li> <a href="/Lua/Server/Server/Functions/GetCheckpoints" title="Lua/Server/Server/Functions/GetCheckpoints">Server:GetCheckpoints</a>
</li>
<li> <a href="/Lua/Server/World/Functions/GetPlayers" title="Lua/Server/World/Functions/GetPlayers">World:GetPlayers</a>
</li>
<li> <a href="/Lua/Server/World/Functions/GetVehicles" title="Lua/Server/World/Functions/GetVehicles">World:GetVehicles</a>
</li>
<li> <a href="/Lua/Server/World/Functions/GetCheckpoints" title="Lua/Server/World/Functions/GetCheckpoints">World:GetCheckpoints</a>
</li>
<li> <a href="/Lua/Client/Client/Functions/GetPlayers" title="Lua/Client/Client/Functions/GetPlayers">Client:GetPlayers</a>
</li>
<li> <a href="/Lua/Client/Client/Functions/GetStreamedPlayers" title="Lua/Client/Client/Functions/GetStreamedPlayers">Client:GetStreamedPlayers</a>
</li>
<li> <a href="/Lua/Client/Client/Functions/GetVehicles" title="Lua/Client/Client/Functions/GetVehicles">Client:GetVehicles</a>
</li>
</ul>
...
<!-- Saved in parser cache with key wiki:pcache:idhash:3749-0!*!0!*!*!*!* and timestamp 20150126054912 and revision id 26666
 -->
</div><div class="printfooter">
Retrieved from "<a href="http://wiki.jc-mp.com/index.php?title=Lua/Tutorials/Iterators&amp;oldid=26666">http://wiki.jc-mp.com/index.php?title=Lua/Tutorials/Iterators&amp;oldid=26666</a>"</div>
	...
	<div id="footer">
		...
		<div id="f-copyrightico"><a href="http://www.gnu.org/copyleft/fdl.html"><img src="/skins/common/images/gnu-fdl.png" alt="GNU Free Documentation License 1.3 or later" width="88" height="31" /></a></div>				</td>
			...
			<ul id="f-list">
					...
					<li id="f-viewcount">This page has been accessed 1,824 times.</li>
