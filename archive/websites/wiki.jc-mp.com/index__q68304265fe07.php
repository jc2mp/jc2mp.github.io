...
<head>
<meta charset="UTF-8" />
<title>View source for Server/Installing scripts - JC2-MP Documentation</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Server/Installing_scripts","wgTitle":"Server/Installing scripts","wgCurRevisionId":25116,"wgRevisionId":0,"wgArticleId":3794,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Installing_scripts","wgIsProbablyEditable":false,"wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Server_Installing_scripts skin-cavendish action-edit">
<div id="internal"></div>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FInstalling+scripts&amp;returntoquery=action%3Dedit">
...
<h6>
<a href="/Main_Page" title="Main Page">View source for Server/Installing scripts - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource" class="selected"><a href="/index.php?title=Server/Installing_scripts&amp;action=edit" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">View source for Server/Installing scripts</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub">← <a href="/Server/Installing_scripts" title="Server/Installing scripts">Server/Installing scripts</a></div>
...
</p><textarea readonly="" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">Scripts should be installed to ''scripts/''. They are automatically loaded on server startup. You can reload a script using the ''reload'' console command, such as ''reload nametags''.
...
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="/Server/Installing_scripts" title="Server/Installing scripts">Server/Installing scripts</a>.</p>
