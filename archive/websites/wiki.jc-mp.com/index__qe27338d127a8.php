...
<head>
<meta charset="UTF-8" />
<title>View source for Client/Launch Options - JC2-MP Documentation</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Client_Launch_Options skin-cavendish action-edit">
<div id="internal"></div>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Client%2FLaunch+Options&amp;returntoquery=action%3Dedit">
...
<h6>
<a href="/Main_Page" title="Main Page">View source for Client/Launch Options - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource" class="selected"><a href="/index.php?title=Client/Launch_Options&amp;action=edit" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">View source for Client/Launch Options</h1>
<div id="bodyContent">
...
!width="140" | '''Command'''
!width="120" | Parameters
!width="400" | Description
|-
| '''connect'''||address:port||Connect to a server. Port is optional.
|-
| '''password'''||string||Used with 'connect' to provide a password.
|-
| '''fontscale'''||number||Changes the scale of all text rendered, default is 1.
|-
| '''name'''||string||Connect using a custom name instead of your Steam name.
|-
| '''x'''||number||Controls the window position.
|-
| '''y'''||number||Controls the window position.
|-
| '''xsize'''||number||Controls the window size.
|-
| '''ysize'''||number||Controls the window size.
|-
|}

==How to use==

You can add these to a JcmpLauncher.exe shortcut or the Steam launch options for JC2-MP.  [http://pcgamingwiki.com/wiki/Just_Cause_2#Command-line_parameters Singleplayer launch options] work, too.


&lt;code>--connect=localhost:7777 --name="Rico Rodriguez" /frameratecap=60&lt;/code>
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="/Client/Launch_Options" title="Client/Launch Options">Client/Launch Options</a>.</p>
