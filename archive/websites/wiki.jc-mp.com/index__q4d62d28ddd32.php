...
<head>
<title>View source for Test History - JC2-MP Documentation</title>
<meta charset="UTF-8" />
<meta name="generator" content="MediaWiki 1.19.1" />
<link rel="next" href="http://wiki.jc-mp.com/index.php/Test_History" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Test_History","wgTitle":"Test History","wgCurRevisionId":813,"wgArticleId":12,"wgIsArticle":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"Test_History","wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Test_History skin-vector action-edit">
		...
		<div id="content" class="mw-body">
			...
			<h1 id="firstHeading" class="firstHeading">
				<span dir="auto">View source for Test History</span>
			</h1>
			<!-- /firstHeading -->
			<!-- bodyContent -->
			<div id="bodyContent">
								<!-- subtitle -->
				<div id="contentSub">← <a href="/index.php/Test_History" title="Test History">Test History</a></div>
				<!-- /subtitle -->
																<!-- jumpto -->
...
</p><textarea readonly="" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">[[Category:Needs improvement]]
...
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="/index.php/Test_History" title="Test History">Test History</a>.</p>
</div>				<!-- /bodycontent -->
								<!-- printfooter -->
				<div class="printfooter">
				Retrieved from "<a href="http://wiki.jc-mp.com/index.php/Test_History">http://wiki.jc-mp.com/index.php/Test_History</a>"				</div>
				<!-- /printfooter -->
												<!-- catlinks -->
...
<div id="p-personal" class="">
	...
	<ul>
		...
		<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Test+History&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
	</ul>
</div>
...
<div id="p-views" class="vectorTabs">
	<h5>Views</h5>
	<ul>
					<li id="ca-view"><span><a href="/index.php/Test_History" >Read</a></span></li>
					<li id="ca-viewsource" class="selected"><span><a href="/index.php?title=Test_History&amp;action=edit"  title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></span></li>
