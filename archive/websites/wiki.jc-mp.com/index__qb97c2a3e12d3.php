...
<head>
<meta charset="UTF-8"/>
<title>View source for Lua/Client/ComboBox - JC2-MP Documentation</title>
<meta http-equiv="X-UA-Compatible" content="IE=EDGE"/>
<meta name="generator" content="MediaWiki 1.23.2"/>
<meta name="robots" content="noindex,nofollow"/>
<script type="text/javascript">
//<![CDATA[
try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:0,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/dok2v=1613a3a185/"},atok:"18e551c24bf0de1f962f19ce340d4682",petok:"d14d8e6dcea7ca98401d2ce6939408c3b43c639a-1413260037-1800",zone:"jc-mp.com",rocket:"0",apps:{"abetterbrowser":{"ie":"8"}}}];!function(a,b){a=document.createElement("script"),b=document.getElementsByTagName("script")[0],a.async=!0,a.src="//ajax.cloudflare.com/cdn-cgi/nexp/dok2v=919620257c/cloudflare.min.js",b.parentNode.insertBefore(a,b)}()}}catch(e){};
//]]>
</script>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lua_Client_ComboBox skin-cavendish action-edit"><script type="text/javascript">
//<![CDATA[
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FClient%2FComboBox&amp;returntoquery=action%3Dedit">
...
<h6>
<a href="/Main_Page" title="Main Page">View source for Lua/Client/ComboBox - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource" class="selected"><a href="/index.php?title=Lua/Client/ComboBox&amp;action=edit" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">View source for Lua/Client/ComboBox</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub">← <a href="/Lua/Client/ComboBox" title="Lua/Client/ComboBox">Lua/Client/ComboBox</a></div>
...
</p><textarea readonly="" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Events==
...
<li><a href="/Template:Lua/Cell_Style/Prototype_List" title="Template:Lua/Cell Style/Prototype List">Template:Lua/Cell Style/Prototype List</a> (<a href="/index.php?title=Template:Lua/Cell_Style/Prototype_List&amp;action=edit" title="Template:Lua/Cell Style/Prototype List">view source</a>) </li><li><a href="/Template:Lua/Cell_Style/Returns_List" title="Template:Lua/Cell Style/Returns List">Template:Lua/Cell Style/Returns List</a> (<a href="/index.php?title=Template:Lua/Cell_Style/Returns_List&amp;action=edit" title="Template:Lua/Cell Style/Returns List">view source</a>) </li><li><a href="/Template:Lua/Client/BaseWindow/Events" title="Template:Lua/Client/BaseWindow/Events">Template:Lua/Client/BaseWindow/Events</a> (<a href="/index.php?title=Template:Lua/Client/BaseWindow/Events&amp;action=edit" title="Template:Lua/Client/BaseWindow/Events">view source</a>) </li><li><a href="/Template:Lua/Client/BaseWindow/Functions" title="Template:Lua/Client/BaseWindow/Functions">Template:Lua/Client/BaseWindow/Functions</a> (<a href="/index.php?title=Template:Lua/Client/BaseWindow/Functions&amp;action=edit" title="Template:Lua/Client/BaseWindow/Functions">view source</a>) </li><li><a href="/Template:Lua/Client/Button/Events" title="Template:Lua/Client/Button/Events">Template:Lua/Client/Button/Events</a> (<a href="/index.php?title=Template:Lua/Client/Button/Events&amp;action=edit" title="Template:Lua/Client/Button/Events">view source</a>) </li><li><a href="/Template:Lua/Client/Button/Functions" title="Template:Lua/Client/Button/Functions">Template:Lua/Client/Button/Functions</a> (<a href="/index.php?title=Template:Lua/Client/Button/Functions&amp;action=edit" title="Template:Lua/Client/Button/Functions">view source</a>) </li><li><a href="/Template:Lua/Client/Label/Functions" title="Template:Lua/Client/Label/Functions">Template:Lua/Client/Label/Functions</a> (<a href="/index.php?title=Template:Lua/Client/Label/Functions&amp;action=edit" title="Template:Lua/Client/Label/Functions">view source</a>) </li><li><a href="/Template:Lua/Column_Style/Prototype_List" title="Template:Lua/Column Style/Prototype List">Template:Lua/Column Style/Prototype List</a> (<a href="/index.php?title=Template:Lua/Column_Style/Prototype_List&amp;action=edit" title="Template:Lua/Column Style/Prototype List">view source</a>) </li><li><a href="/Template:Lua/Column_Style/Returns_List" title="Template:Lua/Column Style/Returns List">Template:Lua/Column Style/Returns List</a> (<a href="/index.php?title=Template:Lua/Column_Style/Returns_List&amp;action=edit" title="Template:Lua/Column Style/Returns List">view source</a>) </li><li><a href="/Template:Lua/Events_Prefix" title="Template:Lua/Events Prefix">Template:Lua/Events Prefix</a> (<a href="/index.php?title=Template:Lua/Events_Prefix&amp;action=edit" title="Template:Lua/Events Prefix">view source</a>) </li><li><a href="/Template:Lua/Events_Suffix" title="Template:Lua/Events Suffix">Template:Lua/Events Suffix</a> (<a href="/index.php?title=Template:Lua/Events_Suffix&amp;action=edit" title="Template:Lua/Events Suffix">view source</a>) </li><li><a href="/Template:Lua/Table_Header" title="Template:Lua/Table Header">Template:Lua/Table Header</a> (<a href="/index.php?title=Template:Lua/Table_Header&amp;action=edit" title="Template:Lua/Table Header">view source</a>) </li><li><a href="/Template:Lua/Table_Prefix" title="Template:Lua/Table Prefix">Template:Lua/Table Prefix</a> (<a href="/index.php?title=Template:Lua/Table_Prefix&amp;action=edit" title="Template:Lua/Table Prefix">view source</a>) </li><li><a href="/Template:Lua/Table_Suffix" title="Template:Lua/Table Suffix">Template:Lua/Table Suffix</a> (<a href="/index.php?title=Template:Lua/Table_Suffix&amp;action=edit" title="Template:Lua/Table Suffix">view source</a>) </li></ul></div><p id="mw-returnto">Return to <a href="/Lua/Client/ComboBox" title="Lua/Client/ComboBox">Lua/Client/ComboBox</a>.</p>
