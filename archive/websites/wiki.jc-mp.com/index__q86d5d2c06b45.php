...
<head>
<meta charset="UTF-8" />
<title>Difference between revisions of "Server/Getting started/Linux Server" - JC2-MP Documentation</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Server/Getting_started/Linux_Server","wgTitle":"Server/Getting started/Linux Server","wgCurRevisionId":27496,"wgRevisionId":24569,"wgArticleId":2836,"wgIsArticle":true,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Getting_started/Linux_Server","wgIsProbablyEditable":false,"wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FLinux+Server&amp;returntoquery=diff%3Dprev%26oldid%3D24569">
...
<h6>
<a href="/Main_Page" title="Main Page">Difference between revisions of &quot;Server/Getting started/Linux Server&quot; - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource"><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;action=edit&amp;oldid=24569" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<li id="t-print"><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;diff=prev&amp;oldid=24569&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
<li id="t-permalink"><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=24569" title="Permanent link to this revision of the page">Permanent link</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">Difference between revisions of "Server/Getting started/Linux Server"</h1>
<div id="bodyContent">
...
<td colspan='2' class='diff-otitle'><div id="mw-diff-otitle1"><strong><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=24556" title="Server/Getting started/Linux Server">Revision as of 19:42, 16 December 2013</a> (<a href="/index.php?title=Server/Getting_started/Linux_Server&amp;action=edit&amp;oldid=24556" title="Server/Getting started/Linux Server">view source</a>)</strong></div><div id="mw-diff-otitle2"><a href="/User:Dreadmullet" title="User:Dreadmullet" class="mw-userlink">Dreadmullet</a> <span class="mw-usertoollinks">(<a href="/User_talk:Dreadmullet" title="User talk:Dreadmullet">Talk</a> | <a href="/Special:Contributions/Dreadmullet" title="Special:Contributions/Dreadmullet">contribs</a>)</span></div><div id="mw-diff-otitle3"></div><div id="mw-diff-otitle5"></div><div id="mw-diff-otitle4"><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;diff=prev&amp;oldid=24556" title="Server/Getting started/Linux Server" id="differences-prevlink">← Older edit</a></div></td>
<td colspan='2' class='diff-ntitle'><div id="mw-diff-ntitle1"><strong><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=24569" title="Server/Getting started/Linux Server">Revision as of 23:52, 16 December 2013</a> (<a href="/index.php?title=Server/Getting_started/Linux_Server&amp;action=edit&amp;oldid=24569" title="Server/Getting started/Linux Server">view source</a>) </strong></div><div id="mw-diff-ntitle2"><a href="/User:RedCat" title="User:RedCat" class="mw-userlink">RedCat</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:RedCat&amp;action=edit&amp;redlink=1" class="new" title="User talk:RedCat (page does not exist)">Talk</a> | <a href="/Special:Contributions/RedCat" title="Special:Contributions/RedCat">contribs</a>)</span> </div><div id="mw-diff-ntitle3"> <span class="comment">(<a href="#Starting_up_the_server_in_screen">→</a>‎<span dir="auto"><span class="autocomment">Starting up the server in screen</span></span>)</span></div><div id="mw-diff-ntitle5"></div><div id="mw-diff-ntitle4"><a href="/index.php?title=Server/Getting_started/Linux_Server&amp;diff=next&amp;oldid=24569" title="Server/Getting started/Linux Server" id="differences-nextlink">Newer edit →</a></div></td>
</tr><tr><td colspan="2" class="diff-lineno">Line 119:</td>
<td colspan="2" class="diff-lineno">Line 119:</td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'></td><td class='diff-marker'>&#160;</td><td class='diff-context'></td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'></td><td class='diff-marker'>&#160;</td><td class='diff-context'></td></tr>
<tr><td colspan="2">&#160;</td><td class='diff-marker'>+</td><td class='diff-addedline'><div><ins class="diffchange">To stop the server and kill the screen type:</ins></div></td></tr>
<tr><td colspan="2">&#160;</td><td class='diff-marker'>+</td><td class='diff-addedline'><div><ins class="diffchange"></ins></div></td></tr>
<tr><td colspan="2">&#160;</td><td class='diff-marker'>+</td><td class='diff-addedline'><div><ins class="diffchange">&lt;syntaxhighlight&gt;</ins></div></td></tr>
<tr><td colspan="2">&#160;</td><td class='diff-marker'>+</td><td class='diff-addedline'><div><ins class="diffchange">screen -S jcmp -X quit</ins></div></td></tr>
<tr><td colspan="2">&#160;</td><td class='diff-marker'>+</td><td class='diff-addedline'><div><ins class="diffchange">&lt;/syntaxhighlight&gt;</ins></div></td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'></td><td class='diff-marker'>&#160;</td><td class='diff-context'></td></tr>
<tr><td class='diff-marker'>&#160;</td><td class='diff-context'><div>==Updating the server==</div></td><td class='diff-marker'>&#160;</td><td class='diff-context'><div>==Updating the server==</div></td></tr>
</table><hr class='diff-hr' />
<h2 class='diff-currentversion-title'>Revision as of 23:52, 16 December 2013</h2>
<p>Welcome to the JC2-MP Linux server tutorial. This page will explain the very basics of setting up a Linux server. This tutorial assumes you already have some basic Linux knowledge.
</p>
<div id="toc" class="toc"><div id="toctitle"><h2>Contents</h2></div>
<ul>
<li class="toclevel-1 tocsection-1"><a href="#64-bit_servers"><span class="tocnumber">1</span> <span class="toctext">64-bit servers</span></a>
<ul>
<li class="toclevel-2 tocsection-2"><a href="#Debian.2C_Ubuntu.2C_Mint"><span class="tocnumber">1.1</span> <span class="toctext">Debian, Ubuntu, Mint</span></a></li>
<li class="toclevel-2 tocsection-3"><a href="#CentOS.2C_RHEL.2C_Fedora"><span class="tocnumber">1.2</span> <span class="toctext">CentOS, RHEL, Fedora</span></a></li>
</ul>
</li>
<li class="toclevel-1 tocsection-4"><a href="#Downloading_SteamCMD"><span class="tocnumber">2</span> <span class="toctext">Downloading SteamCMD</span></a></li>
<li class="toclevel-1 tocsection-5"><a href="#Running_SteamCMD_and_downloading_the_server"><span class="tocnumber">3</span> <span class="toctext">Running SteamCMD and downloading the server</span></a></li>
<li class="toclevel-1 tocsection-6"><a href="#Changing_the_server_options"><span class="tocnumber">4</span> <span class="toctext">Changing the server options</span></a></li>
<li class="toclevel-1 tocsection-7"><a href="#Starting_up_the_server_in_screen"><span class="tocnumber">5</span> <span class="toctext">Starting up the server in screen</span></a></li>
<li class="toclevel-1 tocsection-8"><a href="#Updating_the_server"><span class="tocnumber">6</span> <span class="toctext">Updating the server</span></a></li>
</ul>
</div>
<h2><span class="mw-headline" id="64-bit_servers">64-bit servers</span></h2>
<p>SteamCMD and their libraries are currently 32-bit only, so our server is limited to 32-bit.
You can still run it on a 64-bit server by installing the required packages shown below.
</p>
<h3><span class="mw-headline" id="Debian.2C_Ubuntu.2C_Mint">Debian, Ubuntu, Mint</span></h3>
<div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><div class="lua source-lua"><pre class="de1">dpkg <span class="co1">--add-architecture i386</span>
apt<span class="sy0">-</span>get update
apt<span class="sy0">-</span>get install libc6<span class="sy0">-</span>i386 lib32gcc1 lib32stdc<span class="sy0">++</span><span class="nu0">6</span></pre></div></div>
<h3><span class="mw-headline" id="CentOS.2C_RHEL.2C_Fedora">CentOS, RHEL, Fedora</span></h3>
...
<p>SteamCMD will now update and it might download some files, wait until it finishes.
</p><p><br />
...
<p>Now let's download the latest server version!
</p>
...
Retrieved from "<a href="https://wiki.jc-mp.com/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=24569">https://wiki.jc-mp.com/index.php?title=Server/Getting_started/Linux_Server&amp;oldid=24569</a>"</div>
