...
<link rel="alternate" type="application/atom+xml" title="&quot;Lua/Server/Player/Static Functions/GetById&quot; Atom feed" href="/index.php?title=Lua/Server/Player/Static_Functions/GetById&amp;feed=atom&amp;action=history"/>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lua_Server_Player_Static_Functions_GetById skin-cavendish action-history">
<div id="internal"></div>
...
<span class="top-nav-left">&nbsp;</span>
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FServer%2FPlayer%2FStatic+Functions%2FGetById&amp;returntoquery=action%3Dhistory">
Log in</a>
<span class="top-nav-right">&nbsp;</span></li>
</ul>
</div>
...
<h6>
<a href="/Main_Page" title="Main Page">Revision history of &quot;Lua/Server/Player/Static Functions/GetById&quot; - JC2-MP Documentation</a></h6>
...
<li id="ca-history" class="selected"><a href="/index.php?title=Lua/Server/Player/Static_Functions/GetById&amp;action=history" title="Past revisions of this page">History</a></li> </ul></div>
...
<li id="feedlinks"><a href="/index.php?title=Lua/Server/Player/Static_Functions/GetById&amp;feed=atom&amp;action=history" id="feed-atom" rel="alternate" type="application/atom+xml" class="feedlink" title="Atom feed for this page">Atom</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">Revision history of "Lua/Server/Player/Static Functions/GetById"</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub"><a href="/index.php?title=Special:Log&amp;page=Lua%2FServer%2FPlayer%2FStatic+Functions%2FGetById" title="Special:Log">View logs for this page</a></div>
<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>  
<div id="mw-content-text"><form action="/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Lua/Server/Player/Static_Functions/GetById" name="title"/>
...
<li><span class="mw-history-histlinks">(cur | <a href="/index.php?title=Lua/Server/Player/Static_Functions/GetById&amp;diff=22896&amp;oldid=22895" title="Lua/Server/Player/Static Functions/GetById">prev</a>)</span><input type="radio" value="22896" style="visibility:hidden" name="oldid" id="mw-oldid-null"/><input type="radio" value="22896" checked="checked" name="diff" id="mw-diff-22896"/> <a href="/index.php?title=Lua/Server/Player/Static_Functions/GetById&amp;oldid=22896" title="Lua/Server/Player/Static Functions/GetById" class="mw-changeslist-date">15:13, 15 December 2013</a>‎ <span class='history-user'><a href="/User:Dreadmullet" title="User:Dreadmullet" class="mw-userlink">Dreadmullet</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Dreadmullet&amp;action=edit&amp;redlink=1" class="new" title="User talk:Dreadmullet (page does not exist)">Talk</a> | <a href="/Special:Contributions/Dreadmullet" title="Special:Contributions/Dreadmullet">contribs</a>)</span></span>‎ <abbr class='minoredit' title='This is a minor edit'>m</abbr> <span class="mw-changeslist-separator">. .</span> <span class="history-size">(79 bytes)</span> <span dir="ltr" class="mw-plusminus-null" title="79 bytes after change">(0)</span>‎ <span class="mw-changeslist-separator">. .</span> <span class="comment">(1 revision)</span></li>
<li><span class="mw-history-histlinks">(<a href="/index.php?title=Lua/Server/Player/Static_Functions/GetById&amp;diff=22896&amp;oldid=22895" title="Lua/Server/Player/Static Functions/GetById">cur</a> | prev)</span><input type="radio" value="22895" checked="checked" name="oldid" id="mw-oldid-22895"/><input type="radio" value="22895" name="diff" id="mw-diff-22895"/> <a href="/index.php?title=Lua/Server/Player/Static_Functions/GetById&amp;oldid=22895" title="Lua/Server/Player/Static Functions/GetById" class="mw-changeslist-date">15:13, 15 December 2013</a>‎ <span class='history-user'><a href="/User:Dreadmullet" title="User:Dreadmullet" class="mw-userlink">Dreadmullet</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Dreadmullet&amp;action=edit&amp;redlink=1" class="new" title="User talk:Dreadmullet (page does not exist)">Talk</a> | <a href="/Special:Contributions/Dreadmullet" title="Special:Contributions/Dreadmullet">contribs</a>)</span></span>‎ <span class="mw-changeslist-separator">. .</span> <span class="history-size">(79 bytes)</span> <span dir="ltr" class="mw-plusminus-pos" title="79 bytes after change">(+79)</span>‎ <span class="mw-changeslist-separator">. .</span> <span class="comment">(Autogenerated)</span></li>
</ul>
