...
<head>
<meta charset="UTF-8" />
<title>View source for Client/Console - JC2-MP Documentation</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Client_Console skin-cavendish action-edit">
<div id="internal"></div>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Client%2FConsole&amp;returntoquery=action%3Dedit">
...
<h6>
<a href="/Main_Page" title="Main Page">View source for Client/Console - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource" class="selected"><a href="/index.php?title=Client/Console&amp;action=edit" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">View source for Client/Console</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub">← <a href="/Client/Console" title="Client/Console">Client/Console</a></div>
...
</p><textarea readonly="" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">The console is opened with the ~ or F4 keys.

{| class="wikitable"
!width="120" | '''Command'''
!width="200" | Parameters
...
| '''exit'''||||Quit the game.
|-
| '''gui_hide_fps'''||0 or 1||Show/hide the framerate from the top right.
|-
| '''gui_hide_logo'''||0 or 1||Show/hide the version number from the top right.
|-
| '''password'''||string||Set password for next connection.
|-
| '''profiler_sample'''||seconds||Samples the loaded modules for a given number of seconds and reports the results.
|-
| '''quit'''||||Quit the game.
|-
...
|-
|}
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="/Client/Console" title="Client/Console">Client/Console</a>.</p>
