...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Server/Getting_started/Windows_Server/SteamCMD","wgTitle":"Server/Getting started/Windows Server/SteamCMD","wgCurRevisionId":26735,"wgRevisionId":24546,"wgArticleId":3734,"wgIsArticle":true,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Getting_started/Windows_Server/SteamCMD","wgIsProbablyEditable":false,"wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FWindows+Server%2FSteamCMD&amp;returntoquery=oldid%3D24546">
...
<li id="ca-viewsource"><a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;action=edit&amp;oldid=24546" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<li id="t-print"><a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;oldid=24546&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
<li id="t-permalink"><a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;oldid=24546" title="Permanent link to this revision of the page">Permanent link</a></li>
...
<div id="contentSub"><span class="subpages">&lt; <a href="/Server" title="Server">Server</a>&lrm; | <a href="/Server/Getting_started/Windows_Server" title="Server/Getting started/Windows Server">Getting started/Windows Server</a></span><div id="mw-revision-info">Revision as of 17:29, 16 December 2013 by <a href="/User:Philpax" title="User:Philpax" class="mw-userlink">Philpax</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Philpax&amp;action=edit&amp;redlink=1" class="new" title="User talk:Philpax (page does not exist)">Talk</a> | <a href="/Special:Contributions/Philpax" title="Special:Contributions/Philpax">contribs</a>)</span></div><br />
<div id="mw-revision-nav">(<a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;diff=prev&amp;oldid=24546" title="Server/Getting started/Windows Server/SteamCMD">diff</a>) <a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;direction=prev&amp;oldid=24546" title="Server/Getting started/Windows Server/SteamCMD">← Older revision</a> | <a href="/Server/Getting_started/Windows_Server/SteamCMD" title="Server/Getting started/Windows Server/SteamCMD">Latest revision</a> (<a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;diff=cur&amp;oldid=24546" title="Server/Getting started/Windows Server/SteamCMD">diff</a>) | <a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;direction=next&amp;oldid=24546" title="Server/Getting started/Windows Server/SteamCMD">Newer revision →</a> (<a href="/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;diff=next&amp;oldid=24546" title="Server/Getting started/Windows Server/SteamCMD">diff</a>)</div></div>
<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div> 
<div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><p>Welcome to the JC2-MP Windows server tutorial. This page will explain the very basics of setting up a Windows server using SteamCMD.
</p>
...
<li class="toclevel-1 tocsection-3"><a href="#Installing_the_required_redists"><span class="tocnumber">3</span> <span class="toctext">Installing the required redists</span></a></li>
<li class="toclevel-1 tocsection-4"><a href="#Changing_the_server_options"><span class="tocnumber">4</span> <span class="toctext">Changing the server options</span></a></li>
<li class="toclevel-1 tocsection-5"><a href="#Starting_up_the_server"><span class="tocnumber">5</span> <span class="toctext">Starting up the server</span></a></li>
<li class="toclevel-1 tocsection-6"><a href="#Updating_the_server"><span class="tocnumber">6</span> <span class="toctext">Updating the server</span></a></li>
</ul>
</div>
...
</p><p>Download and extract SteamCMD to an appropriate directory.
</p>
...
<p>Double click SteamCMD.exe. It will update and it might download some files, wait until it finishes.
</p><p>Then it's time to login with an anonymous Steam account to get access to the server
</p>
...
<div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><div class="lua source-lua"><pre class="de1">force_install_dir C<span class="sy0">:/</span>jcmp<span class="sy0">/</span>
...
<h2><span class="mw-headline" id="Installing_the_required_redists">Installing the required redists</span></h2>
...
</p><p>If you are installing from the Steam client, rather than SteamCMD, this will automatically be installed by Steam.
If you are installing from SteamCMD, you <b>must</b> install the redistributable otherwise the server will not be able to launch.
</p>
<h2><span class="mw-headline" id="Changing_the_server_options">Changing the server options</span></h2>
<p>Navigate to your installation path (Assuming you used the above commands exactly, this will be C:/jcmp/).
You can use your favorite text editor to edit the config.lua file.
</p><p>Every possible server option is explained in the configuration file. Simply follow the instructions.
</p><p><br />
</p>
...
</p><p>Double click JcmpServer.exe. It should now say that the server has successfully started.
</p><p><br />
...
Retrieved from "<a href="https://wiki.jc-mp.com/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;oldid=24546">https://wiki.jc-mp.com/index.php?title=Server/Getting_started/Windows_Server/SteamCMD&amp;oldid=24546</a>"</div>
