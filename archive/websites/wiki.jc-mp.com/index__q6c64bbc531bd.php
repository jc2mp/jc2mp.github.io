...
<head>
<title>Lua/Server/Player/Static Functions/Match - JC2-MP Documentation</title>
<meta charset="UTF-8"/>
<meta name="generator" content="MediaWiki 1.21.3"/>
<meta name="robots" content="noindex,nofollow"/>
<script type="text/javascript">
//<![CDATA[
try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:1387493058,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/acv=4125811108/"},atok:"18e551c24bf0de1f962f19ce340d4682",petok:"36f64318d76131120a38fd5cddd5a25b5d45569e-1387595490-1800",zone:"jc-mp.com",rocket:"0",apps:{"abetterbrowser":{"ie":"8"}}}];var a=document.createElement("script"),b=document.getElementsByTagName("script")[0];a.async=!0;a.src="//ajax.cloudflare.com/cdn-cgi/nexp/acv=616370821/cloudflare.min.js";b.parentNode.insertBefore(a,b);}}catch(e){};
//]]>
</script>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lua_Server_Player_Static_Functions_Match skin-cavendish action-view">
<div id="internal"></div>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FServer%2FPlayer%2FStatic+Functions%2FMatch&amp;returntoquery=oldid%3D24623">
Log in</a>
...
<h6>
<a href="/Main_Page" title="Main Page">Lua/Server/Player/Static Functions/Match - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource"><a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;action=edit&amp;oldid=24623" title="This page is protected.&#10;You can view its source">View source</a></li>
<li id="ca-history"><a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;action=history" title="Past revisions of this page">History</a></li> </ul></div>
...
<li id="t-print"><a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;oldid=24623&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
<li id="t-permalink"><a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;oldid=24623" title="Permanent link to this revision of the page">Permanent link</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">Lua/Server/Player/Static Functions/Match</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub"><span class="subpages">&lt; <a href="/Lua" title="Lua">Lua</a>&lrm; | <a href="/Lua/Server" title="Lua/Server">Server</a>&lrm; | <a href="/Lua/Server/Player" title="Lua/Server/Player">Player</a></span><div id="mw-revision-info">Revision as of 17:35, 17 December 2013 by <a href="/User:Dreadmullet" title="User:Dreadmullet" class="mw-userlink">Dreadmullet</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Dreadmullet&amp;action=edit&amp;redlink=1" class="new" title="User talk:Dreadmullet (page does not exist)">Talk</a> | <a href="/Special:Contributions/Dreadmullet" title="Special:Contributions/Dreadmullet">contribs</a>)</span></div><br/>
<div id="mw-revision-nav">(<a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;diff=prev&amp;oldid=24623" title="Lua/Server/Player/Static Functions/Match">diff</a>) <a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;direction=prev&amp;oldid=24623" title="Lua/Server/Player/Static Functions/Match">← Older revision</a> | <a href="/Lua/Server/Player/Static_Functions/Match" title="Lua/Server/Player/Static Functions/Match">Latest revision</a> (<a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;diff=cur&amp;oldid=24623" title="Lua/Server/Player/Static Functions/Match">diff</a>) | <a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;direction=next&amp;oldid=24623" title="Lua/Server/Player/Static Functions/Match">Newer revision →</a> (<a href="/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;diff=next&amp;oldid=24623" title="Lua/Server/Player/Static Functions/Match">diff</a>)</div></div>
<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>  
<div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><hr/>
<table>
<tr>
<th width="100" align="right"><font size="3">Returns</font> &#160;&#160;
</th>
<td><font size="3">table</font>
</td></tr>
<tr>
<th width="100" align="right"><font size="3">Prototype</font> &#160;&#160;
</th>
<td><font size="3">Player.Match(string)</font>
</td></tr></table>
<p><br/>
</p>
<h2> <span class="mw-headline" id="Description">Description</span></h2>
<p>This returns an array of Players whose name contains the string. It only searches from the beginning of player names. It is case insensitive and sorts by name length; the first element is always the shortest.
</p>
<h2> <span class="mw-headline" id="Example">Example</span></h2>
<p>In this example, if Rico Rodriguez is in the server, typing <i>/findplayers rico</i> will print out <i>Found Rico Rodriguez</i>. Searching for <i>Rodriguez" would not work.</i>
</p>
<div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><div class="lua source-lua"><pre class="de1">PlayerChat <span class="sy0">=</span> <span class="kw1">function</span><span class="br0">&#40;</span>args<span class="br0">&#41;</span>
	<span class="kw1">local</span> words <span class="sy0">=</span> args<span class="sy0">.</span>text<span class="sy0">:</span>split<span class="br0">&#40;</span><span class="st0">&quot; &quot;</span><span class="br0">&#41;</span>
&#160;
	<span class="kw1">if</span> <span class="sy0">#</span>words <span class="sy0">==</span> <span class="nu0">2</span> <span class="kw2">and</span> words<span class="br0">&#91;</span><span class="nu0">1</span><span class="br0">&#93;</span> <span class="sy0">==</span> <span class="st0">&quot;/findplayers&quot;</span> <span class="kw1">then</span>
		<span class="kw1">local</span> results <span class="sy0">=</span> Player<span class="sy0">.</span>Match<span class="br0">&#40;</span>words<span class="br0">&#91;</span><span class="nu0">2</span><span class="br0">&#93;</span><span class="br0">&#41;</span>
		<span class="kw1">for</span> index<span class="sy0">,</span> player <span class="kw2">in</span> <span class="kw3">ipairs</span><span class="br0">&#40;</span>results<span class="br0">&#41;</span> <span class="kw1">do</span>
			<span class="kw3">print</span><span class="br0">&#40;</span><span class="st0">&quot;Found &quot;</span><span class="sy0">..</span>player<span class="sy0">:</span>GetName<span class="br0">&#40;</span><span class="br0">&#41;</span><span class="br0">&#41;</span>
...
Retrieved from "<a href="http://wiki.jc-mp.com/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;oldid=24623">http://wiki.jc-mp.com/index.php?title=Lua/Server/Player/Static_Functions/Match&amp;oldid=24623</a>"</div>
