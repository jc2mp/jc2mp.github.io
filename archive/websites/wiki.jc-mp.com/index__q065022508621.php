...
<span class="top-nav-left">&nbsp;</span>
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FServer%2FServer">
Log in</a>
<span class="top-nav-right">&nbsp;</span></li>
</ul>
</div>
...
<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Lua%2FServer%2FServer" title="This is a special page, you cannot edit the page itself">Special page</a></li> </ul></div>
...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Lua/Server/Server">
<h2>Log in</h2>
