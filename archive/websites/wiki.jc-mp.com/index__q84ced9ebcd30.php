...
<head>
<meta charset="UTF-8"/><title>Server/Getting started/FreeBSD Server - JC2-MP Documentation</title>
<meta name="generator" content="MediaWiki 1.22.2"/>
<meta name="robots" content="noindex,nofollow"/>
<script type="text/javascript">
//<![CDATA[
try{if (!window.CloudFlare) {var CloudFlare=[{verbose:0,p:1393322866,byc:0,owlid:"cf",bag2:1,mirage2:0,oracle:0,paths:{cloudflare:"/cdn-cgi/nexp/dok8v=02fcfa4f56/"},atok:"18e551c24bf0de1f962f19ce340d4682",petok:"19d394f2921a04adc871b5d7b55db3fc63972897-1394341641-1800",zone:"jc-mp.com",rocket:"0",apps:{"abetterbrowser":{"ie":"8"}}}];var a=document.createElement("script"),b=document.getElementsByTagName("script")[0];a.async=!0;a.src="//ajax.cloudflare.com/cdn-cgi/nexp/dok8v=221574e73d/cloudflare.min.js";b.parentNode.insertBefore(a,b);}}catch(e){};
//]]>
</script>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Server/Getting_started/FreeBSD_Server","wgTitle":"Server/Getting started/FreeBSD Server","wgCurRevisionId":26043,"wgRevisionId":26043,"wgArticleId":3937,"wgIsArticle":true,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Getting_started/FreeBSD_Server","wgIsProbablyEditable":false,"wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FFreeBSD+Server&amp;returntoquery=oldid%3D26043">
...
<li id="t-print"><a href="/index.php?title=Server/Getting_started/FreeBSD_Server&amp;oldid=26043&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
<li id="t-permalink"><a href="/index.php?title=Server/Getting_started/FreeBSD_Server&amp;oldid=26043" title="Permanent link to this revision of the page">Permanent link</a></li>
...
<div id="contentSub"><span class="subpages">&lt; <a href="/Server" title="Server">Server</a></span><div id="mw-revision-info">Revision as of 19:01, 16 February 2014 by <a href="/index.php?title=User:Pricetx&amp;action=edit&amp;redlink=1" class="new mw-userlink" title="User:Pricetx (page does not exist)">Pricetx</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Pricetx&amp;action=edit&amp;redlink=1" class="new" title="User talk:Pricetx (page does not exist)">Talk</a> | <a href="/Special:Contributions/Pricetx" title="Special:Contributions/Pricetx">contribs</a>)</span></div><br/>
<div id="mw-revision-nav">(<a href="/index.php?title=Server/Getting_started/FreeBSD_Server&amp;diff=prev&amp;oldid=26043" title="Server/Getting started/FreeBSD Server">diff</a>) <a href="/index.php?title=Server/Getting_started/FreeBSD_Server&amp;direction=prev&amp;oldid=26043" title="Server/Getting started/FreeBSD Server">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div></div>
...
<li class="toclevel-1 tocsection-3"><a href="#Part_1:_Setting_up_the_Linux_compatibility_layer"><span class="tocnumber">3</span> <span class="toctext">Part 1: Setting up the Linux compatibility layer</span></a></li>
<li class="toclevel-1 tocsection-4"><a href="#Part_2:_Installing_SteamCMD"><span class="tocnumber">4</span> <span class="toctext">Part 2: Installing SteamCMD</span></a></li>
<li class="toclevel-1 tocsection-5"><a href="#Step_3:_Acquiring_libstdc.2B.2B.so.6"><span class="tocnumber">5</span> <span class="toctext">Step 3: Acquiring libstdc++.so.6</span></a></li>
<li class="toclevel-1 tocsection-6"><a href="#Step_4:_Running_JC2-MP"><span class="tocnumber">6</span> <span class="toctext">Step 4: Running JC2-MP</span></a></li>
</ul>
</div>
<h2><span class="mw-headline" id="Introduction">Introduction</span></h2>
<p>This is a guide to running the server software for JC2-MP under FreeBSD.
</p>
...
<h2><span class="mw-headline" id="Part_1:_Setting_up_the_Linux_compatibility_layer">Part 1: Setting up the Linux compatibility layer</span></h2>
...
<h2><span class="mw-headline" id="Part_2:_Installing_SteamCMD">Part 2: Installing SteamCMD</span></h2>
<p>First, we need to set up SteamCMD. First make a directory for it somewhere, and run the following command:
</p>
...
</p><p>Now we need to download the game itself, this is also the command used to update the game.
</p>
<div dir="ltr" class="mw-geshi mw-code mw-content-ltr"><div class="lua source-lua"><pre class="de1">app_update <span class="nu0">261140</span></pre></div></div>
<p>NOTE: if it hangs during the download, simply exit (ctrl+c), and re-run steamcmd_freebsd.sh.
...
<h2><span class="mw-headline" id="Step_3:_Acquiring_libstdc.2B.2B.so.6">Step 3: Acquiring libstdc++.so.6</span></h2>
...
<h2><span class="mw-headline" id="Step_4:_Running_JC2-MP">Step 4: Running JC2-MP</span></h2>
...
Retrieved from "<a href="http://wiki.jc-mp.com/index.php?title=Server/Getting_started/FreeBSD_Server&amp;oldid=26043">http://wiki.jc-mp.com/index.php?title=Server/Getting_started/FreeBSD_Server&amp;oldid=26043</a>"</div>
...
<td align="center">
<ul id="f-list">
<li id="f-lastmod"> This page was last modified on 16 February 2014, at 19:01.</li>
<li id="f-viewcount">This page has been accessed 209 times.</li>
