...
<head>
<meta charset="UTF-8" />
<title>Pages that link to "Server/Getting started/Windows Server" - JC2-MP Documentation</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"Special","wgCanonicalSpecialPageName":"Whatlinkshere","wgNamespaceNumber":-1,"wgPageName":"Special:WhatLinksHere/Server/Getting_started/Windows_Server","wgTitle":"WhatLinksHere/Server/Getting started/Windows Server","wgCurRevisionId":0,"wgRevisionId":0,"wgArticleId":0,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Getting_started/Windows_Server","wgIsProbablyEditable":false});
...
<body class="mediawiki ltr sitedir-ltr ns--1 ns-special mw-special-Whatlinkshere page-Special_WhatLinksHere_Server_Getting_started_Windows_Server skin-cavendish action-view">
<div id="internal"></div>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Special%3AWhatLinksHere%2FServer%2FGetting+started%2FWindows+Server&amp;returntoquery=hidelinks%3D1%26hidetrans%3D1">
...
<h6>
<a href="/Main_Page" title="Main Page">Pages that link to &quot;Server/Getting started/Windows Server&quot; - JC2-MP Documentation</a></h6>
...
<li id="t-print"><a href="/index.php?title=Special:WhatLinksHere/Server/Getting_started/Windows_Server&amp;hidelinks=1&amp;hidetrans=1&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
</ul>
</div>
</div>
</div>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">Pages that link to "Server/Getting started/Windows Server"</h1>
<div id="bodyContent">
...
<label for="mw-whatlinkshere-target">Page:</label>&#160;<input name="target" size="40" value="Server/Getting started/Windows Server" id="mw-whatlinkshere-target" /> <label for="namespace">Namespace:</label>&#160;<select class="namespaceselector" id="namespace" name="namespace">
...
<a href="/index.php?title=Special:WhatLinksHere/Server/Getting_started/Windows_Server&amp;hidelinks=1" title="Special:WhatLinksHere/Server/Getting started/Windows Server">Show</a> transclusions | <a href="/index.php?title=Special:WhatLinksHere/Server/Getting_started/Windows_Server&amp;hidetrans=1" title="Special:WhatLinksHere/Server/Getting started/Windows Server">Show</a> links | <a href="/index.php?title=Special:WhatLinksHere/Server/Getting_started/Windows_Server&amp;hidetrans=1&amp;hidelinks=1&amp;hideredirs=1" title="Special:WhatLinksHere/Server/Getting started/Windows Server">Hide</a> redirects
</fieldset>
<p>No pages link to <strong><a href="/Server/Getting_started/Windows_Server" title="Server/Getting started/Windows Server">Server/Getting started/Windows Server</a></strong>.
</p></div><div class="printfooter">
Retrieved from "<a href="https://wiki.jc-mp.com/Special:WhatLinksHere/Server/Getting_started/Windows_Server">https://wiki.jc-mp.com/Special:WhatLinksHere/Server/Getting_started/Windows_Server</a>"</div>
