...
<span class="top-nav-left">&nbsp;</span>
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FLinux+Server">
Log in</a>
<span class="top-nav-right">&nbsp;</span></li>
</ul>
</div>
...
<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FGetting+started%2FLinux+Server" title="This is a special page, you cannot edit the page itself">Special page</a></li> </ul></div>
...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Server/Getting+started/Linux+Server">
<h2>Log in</h2>
...
<input type="hidden" name="wpLoginToken" value="4998f314b1c6f7bab68bc7cccbc81bf1"/></form>
</div>
<div id="loginend"></div>
