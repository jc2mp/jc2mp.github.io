...
<head>
<meta charset="UTF-8" />
<title>View source for Server/Launch Options - JC2-MP Documentation</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Server/Launch_Options","wgTitle":"Server/Launch Options","wgCurRevisionId":27441,"wgRevisionId":0,"wgArticleId":4377,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Server/Launch_Options","wgIsProbablyEditable":false,"wgRestrictionEdit":[],"wgRestrictionMove":[]});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Server_Launch_Options skin-cavendish action-edit">
<div id="internal"></div>
...
<a class="top-nav-mid " href="/index.php?title=Special:UserLogin&amp;returnto=Server%2FLaunch+Options&amp;returntoquery=action%3Dedit">
...
<h6>
<a href="/Main_Page" title="Main Page">View source for Server/Launch Options - JC2-MP Documentation</a></h6>
...
<li id="ca-viewsource" class="selected"><a href="/index.php?title=Server/Launch_Options&amp;action=edit" title="This page is protected.&#10;You can view its source">View source</a></li>
...
<div id="content">
<a id="top"></a>
<h1 id="firstHeading" class="firstHeading">View source for Server/Launch Options</h1>
<div id="bodyContent">
<h3 id="siteSub">From JC2-MP Documentation</h3>
<div id="contentSub">← <a href="/Server/Launch_Options" title="Server/Launch Options">Server/Launch Options</a></div>
...
| '''bindport'''||number||
|-
| '''sled'''||||Enable SLED debugger (Windows only)
|-
| '''sledport'''||||SLED debugger port (Windows only)
|-
|}
</textarea><div class="templatesUsed"></div><p id="mw-returnto">Return to <a href="/Server/Launch_Options" title="Server/Launch Options">Server/Launch Options</a>.</p>
